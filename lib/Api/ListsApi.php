...
class ListsApi
{
    ...
    public function createListMemberEvent($list_id, $subscriber_hash, $body = null)
    {
        $this->createListMemberEventWithHttpInfo($list_id, $subscriber_hash, $body);
    }

    public function createListMemberEventWithHttpInfo($list_id, $subscriber_hash, $body = null)
    {
    ...
    protected function createListMemberEventRequest($list_id, $subscriber_hash, $body = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
